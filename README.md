...
- 🛠 Created various open-source libraries:
  ...
  - [🏠 PRIME](https://estatemonitorcore.github.io) - This is a dynamic web dashboard that visualizes 290,000 real estate transaction records on a map using Dash/Plotly, with the data stored in Supabase. [Developing]
