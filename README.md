...
- 🛠 Created various open-source libraries:
  ...
  - [💊 Autofic](https://autofic.github.io) - A system that automatically detects security vulnerabilities in code, applies patches, and generates PR for seamless integration [📑 Paper](https://drive.google.com/file/d/1R3YJRcVCDjqAKCcpQp3u2JyK1ouGf0w6/view?usp=sharing) & [📊 Poster](https://drive.google.com/file/d/1U4YUryzdfU9vX3qAr38-P5lOKxLzO_h6/view?usp=sharing) & [🥇 Award](https://drive.google.com/file/d/1Pec-udS-5RLdiTHsQlt03JyRTjgB-V24/view?usp=sharing)
  - [🏠 PRIME](https://prime-insight.vercel.app) - This is a dynamic web dashboard that visualizes 290,000 real estate transaction records on a map using Dash/Plotly, with the data stored in Supabase. [Developing]
